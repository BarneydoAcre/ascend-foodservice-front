                        ...
                        <v-card-text>
                            <v-form v-model="validForm" ref="form" lazy-validation>
                                <v-row v-if="form.person_f_j">
                                    ...
                                    <!-- <v-col cols="3">
                                        <SelectCity ref="selectedCity"></SelectCity>
                                    </v-col> -->
                                </v-row>
                                <v-row dense v-else>
                                    <v-col cols="6">
                                    ...
                                    <v-col cols="3"
                                    color="primary">
                                        <v-text-field dense filled :loading="loadingSelect" @click="getCities" @keydown.enter="filterCity" label="Prato" v-model="form.city.name" :rules="rules"></v-text-field>
                                    </v-col>
...
<script>
import SelectCity from "./actions/SelectCity.vue"
export default {
    name: 'Customer',
    components: {
        SelectCity,
