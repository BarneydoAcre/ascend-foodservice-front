    ...
    data() {
        return {
            items: [
                ...
                { title: "Contas à Receber (Em Breve)", icon: "mdi-bank-transfer-in", link: "contas-receber/", disabled: true },
                { title: "Contas à Pagar (Em Breve)", icon: "mdi-bank-transfer-out", link: "contas-pagar/", disabled: true },
